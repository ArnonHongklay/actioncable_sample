(function() {
    ...
    (function() {
      ...
      this.ActionCable = {
        ...
        createConsumer: function(url) {
          var ref;
          if (url == null) {
            url = (ref = this.getConfig('url')) != null
              ? ref
  ...
  (function() {
    (function() {
      ...
      ActionCable.ConnectionMonitor = (function() {
        ...
        ConnectionMonitor.prototype.getPollInterval = function() {
          ...
          (ref = this.constructor.pollInterval), (min = ref.min), (max =
            ref.max);
    ...
    (function() {
      ...
      (ref = ActionCable.INTERNAL), (message_types =
        ref.message_types), (protocols = ref.protocols);
      ...
      ActionCable.Connection = (function() {
        ...
        Connection.prototype.isProtocolSupported = function() {
          var ref1;
          return (ref1 = this.getProtocol()), indexOf.call(
            supportedProtocols,
            ref1,
          ) >= 0;
        };
        ...
        Connection.prototype.events = {
          message: function(event) {
            ...
            (ref1 = JSON.parse(event.data)), (identifier =
              ref1.identifier), (message = ref1.message), (type = ref1.type);
            switch (type) {
    ...
    (function() {
      ...
      ActionCable.Subscriptions = (function() {
        ...
        Subscriptions.prototype.notifyAll = function() {
          ...
          (callbackName = arguments[0]), (args = 2 <= arguments.length
        ...
        Subscriptions.prototype.notify = function() {
          ...
          (subscription = arguments[0]), (callbackName =
            arguments[1]), (args = 3 <= arguments.length
